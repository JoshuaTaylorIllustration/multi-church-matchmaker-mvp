    ...
    <main className="min-h-screen bg-[#e9e9e9] px-4 py-16">
      <section className="mx-auto grid w-full max-w-[768px] grid-cols-12 rounded-[24px] bg-white px-[64px] pb-[64px] pt-[64px] shadow-[0_2px_8px_rgba(0,0,0,0.18)]">
        <div className="col-span-12">
          <p className="inline-flex w-fit rounded-full bg-flyerYellow px-[16px] py-[8px] text-[36px]/[1] font-bold text-black">
          ...
          <header className="mt-[32px]">
            ...
            <p className="mt-[32px] max-w-[640px] text-[40px]/[1.35] text-[#1b1b1b]">
        ...
        <div className="col-span-12 mt-[64px] grid grid-cols-12 gap-[32px]">
          <button
            type="button"
            className="col-span-6 rounded-[12px] bg-flyerYellow px-[24px] py-[20px] text-[44px]/[1] font-extrabold uppercase tracking-tight text-black shadow-[0_4px_8px_rgba(0,0,0,0.18)] transition hover:brightness-95"
          >
            Sign Up
          </button>
          <button
            type="button"
            className="col-span-6 rounded-[12px] bg-white px-[24px] py-[20px] text-[44px]/[1] font-extrabold uppercase tracking-tight text-black shadow-[0_4px_8px_rgba(0,0,0,0.18)] transition hover:bg-gray-50"
          >
            Log In
          </button>
        </div>

        <p className="col-span-12 mt-[32px] text-[40px]/[1.25] text-[#1b1b1b]">
